...
import { createProductHandler, deleteProductHandler, getProductHandler, updateProductHandler } from './controllers/productController';
...
const routes = (app: Express) => {
    ...
    app.delete("/api/products/:productsId", [requireUser, validateResource(deleteProductSchema)], deleteProductHandler);
}
